...
const ProductList=[
    ...
    {id:6, title:"Zapatillas Emerica", price:"$7.000", stock:14, image:Img7, category:"skate",description:"Las Emerica JKK combinan un look minimalista con un ajuste moderno. El modelo se ha actualizado con una nueva plantilla suave y una suela exterior flexible para ofrecer un mejor contacto con la tabla desde el primer momento." },
    {id:7, title:"Zapatillas Etnies", price:"$6.000", stock:22, image:Img8, category:"skate",description:"Las Etnies 111 combinan un look minimalista con un ajuste moderno. El modelo se ha actualizado con una nueva plantilla suave y una suela exterior flexible para ofrecer un mejor contacto con la tabla desde el primer momento." },
    {id:8, title:"Zapatillas DC 1", price:"$4.200", stock:30, image:Img9, category:"skate" ,description:"Las DC 124 combinan un look minimalista con un ajuste moderno. El modelo se ha actualizado con una nueva plantilla suave y una suela exterior flexible para ofrecer un mejor contacto con la tabla desde el primer momento."},
    {id:9, title:"Zapatillas DC 2", price:"$5.300", stock:14, image:Img10, category:"skate",description:"Las DC EE  combinan un look minimalista con un ajuste moderno. El modelo se ha actualizado con una nueva plantilla suave y una suela exterior flexible para ofrecer un mejor contacto con la tabla desde el primer momento." },
    {id:10, title:"Zapatillas DC 3", price:"$4.000", stock:30, image:Img11, category:"skate",description:"Las DC AA  combinan un look minimalista con un ajuste moderno. El modelo se ha actualizado con una nueva plantilla suave y una suela exterior flexible para ofrecer un mejor contacto con la tabla desde el primer momento." },
    {id:11, title:"Zapatillas DC 4", price:"$5.300", stock:11, image:Img12, category:"running",description:"Las DC SD  combinan un look minimalista con un ajuste moderno. El modelo se ha actualizado con una nueva plantilla suave y una suela exterior flexible para ofrecer un mejor contacto con la tabla desde el primer momento." },
    {id:12, title:"Zapatillas DC 5", price:"$5.300", stock:2, image:Img13, category:"urban",description:"Las DC EW  combinan un look minimalista con un ajuste moderno. El modelo se ha actualizado con una nueva plantilla suave y una suela exterior flexible para ofrecer un mejor contacto con la tabla desde el primer momento." },
